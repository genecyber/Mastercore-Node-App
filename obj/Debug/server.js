...
// Test route to something mastercore specific (Actually performs 2 queries )
router.get('/getProtocolBalance/:address/:id', function(req, res) {
    async.series([
        ...
        function(err, results) {
            res.render("getProtocolBalance", { Id: req.params.id, Address: req.params.address, Balance: results[0], Details: results[1][0] });
        }
    );
});
